...
from src.lerobot.robots import RobotConfig
...
@EnvConfig.register_subclass("walker_s2_sim")
@dataclass
class WalkerS2SimEnv(EnvConfig):
    task: str | None = "Conveyor_Sorting"
    fps: int = 30
    ...
    camera_keys: str = "head_left,head_right,wrist_left,wrist_right"
    ...
    @property
    def gym_kwargs(self) -> dict:
        return {"headless": self.headless, "task": self.task}
