...
from src.lerobot.datasets.utils import DEFAULT_FEATURES
from src.lerobot.policies.pretrained import PreTrainedPolicy
from src.lerobot.policies.utils import prepare_observation_for_inference, prepare_observation_for_inference_walker_s2
from src.lerobot.processor import PolicyAction, PolicyProcessorPipeline
from src.lerobot.robots import Robot
...
def predict_action(
    ...
    with (
        ...
        # action = policy.select_action_full(observation)
