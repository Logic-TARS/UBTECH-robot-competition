...
/isaac-sim/python.sh -m lerobot.scripts.auto_collect_main \
    ...
    --auto_collect.root=datasets/Part_Sorting/auto/episode_200_v4_a_2_b_2 \
    --auto_collect.num_episodes=200 \
    --auto_collect.single_task="Part Sorting" \
    --auto_collect.record_data=true \
    --auto_collect.video=true \
    --auto_collect.enable_keyboard_listener=true \
    --auto_collect.return_home_after_part=true \
    --auto_collect.fps=30
...
/isaac-sim/python.sh -m lerobot.scripts.auto_collect_main \
    ...
    --auto_collect.root=datasets/Conveyor_Sorting/auto/episode_60_v1 \
    --auto_collect.num_episodes=60 \
...
/isaac-sim/python.sh -m lerobot.scripts.auto_collect_main \
    ...
    --auto_collect.task=Conveyor_Sorting \
    --auto_collect.repo_id=sjj/Conveyor_Sorting_auto \
    --auto_collect.root=datasets/Conveyor_Sorting/auto/episode_60_v2 \
    --auto_collect.num_episodes=60 \
    --auto_collect.single_task="Conveyor Sorting" \
    --auto_collect.record_data=true \
    --auto_collect.video=true \
...
/isaac-sim/python.sh -m lerobot.scripts.auto_collect_main \
    ...
    --auto_collect.task=Conveyor_Sorting \
    --auto_collect.repo_id=sjj/Conveyor_Sorting_auto \
    --auto_collect.root=datasets/Conveyor_Sorting/auto/episode_60_v3 \
    --auto_collect.num_episodes=60 \
    --auto_collect.single_task="Conveyor Sorting" \
    --auto_collect.record_data=true \
    --auto_collect.video=true \
...
/isaac-sim/python.sh -m lerobot.scripts.auto_collect_main \
    ...
    --auto_collect.task=Conveyor_Sorting \
    --auto_collect.repo_id=sjj/Conveyor_Sorting_auto \
    --auto_collect.root=datasets/Conveyor_Sorting/auto/episode_60_v4 \
    --auto_collect.num_episodes=60 \
    --auto_collect.single_task="Conveyor Sorting" \
    --auto_collect.record_data=true \
    --auto_collect.video=true \
...
/isaac-sim/python.sh -m lerobot.scripts.auto_collect_main \
  ...
  --auto_collect.record_data=true \
  --auto_collect.video=true \
  --auto_collect.enable_keyboard_listener=false \
  --auto_collect.fps=30 \
...
| `--auto_collect.enable_keyboard_listener`            | 是否启用键盘监听（ESC 停止录制、左方向键重录）       | `true`                   |
| `--auto_collect.video`                               | 是否录制视频                                         | `true`                   |
| `--auto_collect.single_task`                         | 任务描述（不填则自动使用 task 名）                   | None                       |
| `--auto_collect.max_retries`                         | 单 episode 抓取失败最大重试次数                      | `20`                     |
| `--auto_collect.objects_per_episode`                 | 每 episode 最大物体数（0=全部）                      | `0`                      |
| `--auto_collect.return_home_after_part`              | 每个零件完成后是否让对应手臂回到初始位置             | `true`                   |
