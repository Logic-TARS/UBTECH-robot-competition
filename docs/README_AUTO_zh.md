...
/isaac-sim/python.sh -m lerobot.scripts.auto_collect_main \
    ...
    --auto_collect.root=datasets/Part_Sorting/auto/episode_200_v2_a_2_b_2 \
...
/isaac-sim/python.sh -m lerobot.scripts.auto_collect_main \
    ...
    --auto_collect.root=datasets/Conveyor_Sorting/auto/episode_100_v1 \
...
/isaac-sim/python.sh -m lerobot.scripts.auto_collect_main \
    ...
    --auto_collect.task=Conveyor_Sorting \
    --auto_collect.repo_id=sjj/Conveyor_Sorting_auto \
    --auto_collect.root=datasets/Conveyor_Sorting/auto/episode_100_v2 \
    --auto_collect.num_episodes=100 \
    --auto_collect.single_task="Conveyor Sorting" \
    --auto_collect.record_data=true \
    --auto_collect.video=true \
...
/isaac-sim/python.sh -m lerobot.scripts.auto_collect_main \
    ...
    --auto_collect.task=Conveyor_Sorting \
    --auto_collect.repo_id=sjj/Conveyor_Sorting_auto \
    --auto_collect.root=datasets/Conveyor_Sorting/auto/episode_100_v3 \
    --auto_collect.num_episodes=100 \
    --auto_collect.single_task="Conveyor Sorting" \
    --auto_collect.record_data=true \
    --auto_collect.video=true \
...
/isaac-sim/python.sh -m lerobot.scripts.auto_collect_main \
    ...
    --auto_collect.task=Conveyor_Sorting \
    --auto_collect.repo_id=sjj/Conveyor_Sorting_auto \
    --auto_collect.root=datasets/Conveyor_Sorting/auto/episode_100_v4 \
    --auto_collect.num_episodes=100 \
    --auto_collect.single_task="Conveyor Sorting" \
    --auto_collect.record_data=true \
    --auto_collect.video=true \
