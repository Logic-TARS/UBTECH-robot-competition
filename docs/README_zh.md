...
/isaac-sim/python.sh -m lerobot.scripts.auto_collect_main \
    ...
    --auto_collect.source_root=datasets/Packing_Box \
...
```bash
challenge2026_baseline/Part_Sorting/act/train_5_7/080000/pretrained_modelchallenge2026_baseline/Part_Sorting/act/train_5_7/080000/pretrained_model# 设置haggface镜像
export HF_ENDPOINT=https://hf-mirror.com
/isaac-sim/python.sh src/lerobot/scripts/lerobot_record.py \
    --robot.type=walker_s2_sim \
    --robot.headless=false \
    --task=Part_Sorting \
    --policy.path=challenge2026_baseline/Part_Sorting/acttrain_5_14_obj_4/checkpoints/100000/pretrained_model \
...
│   │   ├── task_conveyor_sorting.py # Task 2 子类
