...
────────────────────────────────────────────────────────────
  ...
  目录批量模式:
    python dataset_post_process/split_conveyor_episodes.py directory \
        --source-dir datasets/Conveyor_Sorting/auto \
        --output-parent-dir datasets/Conveyor_Sorting/auto_short_parts

    /isaac-sim/python.sh dataset_post_process/split_conveyor_episodes.py directory \
        --source-dir datasets/Conveyor_Sorting/auto \
        --output-parent-dir datasets/Conveyor_Sorting/auto_short_parts
  ...
  查看帮助:
    python dataset_post_process/split_conveyor_episodes.py --help
    python dataset_post_process/split_conveyor_episodes.py single --help
    python dataset_post_process/split_conveyor_episodes.py directory --help
"""
