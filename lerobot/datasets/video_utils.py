...
def concatenate_video_files(
    ...
    try:
        ...
        )  # faststart moves metadata to beginning of file to speed up loading

        if hasattr(output_container, "add_stream_from_template"):
            # PyAV >= 13 path: remux by cloning stream templates
            stream_map = {}
            ...
            # PyAV < 13 fallback: use ffmpeg concat demuxer + stream copy
