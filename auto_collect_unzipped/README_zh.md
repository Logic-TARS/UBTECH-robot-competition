...
/isaac-sim/python.sh lerobot/scripts/control_robot.py
    --robot.type=walker_s2_sim
    --control.root=/workspace/GlobalHumanoidRobotChallenge2026_Baseline/datasets/Part_Sorting/v1
    --control.type=record
...
/isaac-sim/python.sh lerobot/scripts/control_robot.py \
    --robot.type=walker_s2_sim \
    --control.root=Conveyor_Sorting/episode_250_v1 \
    --control.type=record \
    --control.task=Conveyor_Sorting \
    --control.fps=30 \
    --control.single_task="Conveyor_Sorting" \
    --control.repo_id=alpha/jay-conveyor_sorting_001 \
...
/isaac-sim/python.sh lerobot/scripts/control_robot.py \
    --robot.type=walker_s2_sim \
    --control.root=Conveyor_Sorting/episode_250_v2 \
    --control.type=record \
    --control.task=Conveyor_Sorting \
    --control.fps=30 \
    --control.single_task="Conveyor_Sorting" \
...
/isaac-sim/python.sh lerobot/scripts/control_robot.py \
    --robot.type=walker_s2_sim \
    --control.root=Conveyor_Sorting/episode_250_v3 \
    --control.type=record \
    --control.task=Conveyor_Sorting \
    --control.fps=30 \
    --control.single_task="Conveyor_Sorting" \
...
/isaac-sim/python.sh lerobot/scripts/control_robot.py \
    --robot.type=walker_s2_sim \
    --control.root=Conveyor_Sorting/episode_250_v4 \
    --control.type=record \
    --control.task=Conveyor_Sorting \
    --control.fps=30 \
    --control.single_task="Conveyor_Sorting" \
...
/isaac-sim/python.sh lerobot/scripts/control_robot.py \
    --robot.type=walker_s2_sim \
    --control.root=Conveyor_Sorting/episode_500_v4 \
    --control.type=record \
    --control.task=Conveyor_Sorting \
    --control.fps=30 \
    --control.single_task="Conveyor_Sorting" \
    --control.repo_id=alpha/jay-conveyor_sorting_001 \
    --control.num_episodes=500 \
    --control.warmup_time_s=0 \
    --control.episode_time_s=10000 \
    --control.reset_time_s=10 \
    --control.push_to_hub=false \
...
/isaac-sim/python.sh lerobot/scripts/control_robot.py \
    --robot.type=walker_s2_sim \
    --control.root=Conveyor_Sorting/episode_500_v3 \
    --control.type=record \
    --control.task=Conveyor_Sorting \
    --control.fps=30 \
    --control.single_task="Conveyor_Sorting" \
...
/isaac-sim/python.sh -m pip install python-dotenv
...
| `control.objects_per_episode` | 每个 episode 处理的物体数量（0=全部） | `1`           |
